              ...
              <td align="center"><table border="0" cellspacing="0" cellpadding="0" style="border:1px solid #000; width:100%;">
                  <tbody>
                    <tr>
                      ...
                      <td align="center" style="font-weight:bold;background-color:#6DA9CB;color:#fff;padding-right:30px;"> Search Id No. </td>
                      <form action="treeview.php" method="post">
                      </form>
                      <td align="right" style="background:#367fa9;"><input type="text" id="userid" name="userid" class="form-control" style="width:200px;" placeholder="-Input Ownid-">
                      </td>
                      <td align="center" style="background:#367fa9;"><input type="submit" id="submit" name="submit" value="Search" style="background: #053b5a; color: #fff; border: none; padding: 8px 15px;  cursor: pointer;">
                      </td>
                    </tr>
                  </tbody>
                </table></td>
